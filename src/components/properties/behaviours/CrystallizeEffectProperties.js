      ...
      <div className={isSubmenuVisible}>
        ...
        <div className="form-group">
          <div className="col-xs-12">
            ...
            >
              {isRunningRef.current ? "Running..." : "Trigger Crystallize"}
            </button>
          </div>
        </div>
        <hr />
        <InputNumber
          label="Cell Scale"
          id="cellScale"
          value={config.cellScale}
          step="1"
          min="2"
          max="64"
          onChange={(v) => updateConfig({ cellScale: v })}
        />
        <InputNumber
          label="Jitter"
          id="jitter"
        ...
        <InputNumber
          ...
          id="highlightStrength"
          value={config.highlightStrength}
          step="0.1"
          min="0"
          max="1"
          onChange={(v) => updateConfig({ highlightStrength: v })}
        />
        <InputNumber
          label="Edge Softness"
          id="edgeSoftness"
          ...
          min="0"
          max="1"
          onChange={(v) => updateConfig({ edgeSoftness: v })}
        />
        <Checkbox
          label="Tint By Cell"
          id="tintByCell"
          onChange={(v) => updateConfig({ tintByCell: v })}
          checked={config.tintByCell}
        />
        <InputNumber
          label="Duration"
          id="duration"
